...
class BinaryTree:
    ...
    class _Node:
        ...
        def __init__(self, e, p=None, l=None, r=None):
            ...
            self._left = l
            self._right = r
            self._path = []  # list of nodes indicating the path from root to this node
    ...
    def paths_to_all_leaves(self):
        ...
        if not self.is_empty():
            self._subtree_paths_to_all_leaves(self.root())   # build tree's path collection from root
    ...
    def _subtree_paths_to_all_leaves(self, n):
        ...
        if self.is_leaf(n):                         # if n is leaf
            self._path_collection.append(n._path)   # add its path to tree's path collection
