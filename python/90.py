...
# task: generate random numbers & calculate their probabilities 
    n = 10  # n initialized
    l = [i for i in range(n) if i%2==0] # list l initialized: all even integers < n
    freq = {i:0 for i in range(n) if i not in l}    # dict freq initialized: frequency of each possible output
