...
def building_view_sunset(building_heights):
    ...
    max_height[n-1] = building_heights[n-1]    # rightmost building can always view the sunset
    num_buildings = 1    # output initialized. Rightmost building can always view the sunset
