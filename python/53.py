...
class QueueFrom2Stacks:
    ...
    def dequeue(self):
        ...
        while (
            self.stack1
        ):  # push elements in stack1 from last into stack2, i.e 1st element in queue is last element in stack2
            li = self.stack1.pop()
            self.stack2.append(li)
        fo = (
            self.stack2.pop()
        )  # 1st element in queue is last element in stack2
        while (
            self.stack2
        ):  # push elements in stack2 from last into stack1, i.e 1st element in queue is 1st element in stack1
            fi = self.stack2.pop()
