...
# output: 0/1 but the probability of 0/1 will be biased by 'biased_rate'
    return int(random.random() < biased_rate) # prob(1) = biased_rate, prob(0) = 1 - biased_rate
...
def main():
    ...
    bias = {0: 0, 1: 0} # dict of toss_biased(): frequencies of 0 and 1 separately
    unbias = {0: 0, 1: 0}   # dict of toss_unbiased: frequencies of 0 and 1 separately
    ...
    print('Unbias:\t0 ~>', unbias[0]/iterations, ';\t1 ~>', unbias[1]/iterations)
