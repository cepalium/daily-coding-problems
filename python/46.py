...
def longestPalindromicSubstring(string):
    ...
    leftToRight_longestPalindromicSubstring = (
        longestPalindromicSubstring_pivotToRight(string)
    )
    rightToLeft_longestPalindromicSubstring = (
        longestPalindromicSubstring_pivotToRight(string[::-1])
    )  # input inversed string for method
    if len(leftToRight_longestPalindromicSubstring) > len(
        rightToLeft_longestPalindromicSubstring
    ):
        longestPalindromicSubstring = leftToRight_longestPalindromicSubstring
    else:
        longestPalindromicSubstring = rightToLeft_longestPalindromicSubstring[
            ::-1
        ]
